...
#include "Objects/Planets/Sun/Sun.h"
#include "Objects/Planets/Earth/Earth.h"
...
void Application::Update()
{
	...
	{
		Math::Matrix _mTrans =
			Math::Matrix::CreateTranslation(0, 0, -10);
	...
	//全ゲームオブジェクトの更新
	{
		for (std::shared_ptr<KdGameObject> _gameObj : m_gameObjList)
		{
			_gameObj->Update();
		}
	}
